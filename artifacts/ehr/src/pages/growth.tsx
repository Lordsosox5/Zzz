...
const emptyForm = { patientId: "", patientName: "", measurementDate: "", weight: "", height: "", headCircumference: "", notes: "" };
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Dialog open={isOpen} onOpenChange={(v) => { setIsOpen(v); if (!v) setForm(emptyForm); }}>
          ...
          <DialogContent className="max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 py-2">
              ...
              <div className="flex justify-end gap-2 pt-2">
                <Button type="button" variant="outline" onClick={() => { setIsOpen(false); setForm(emptyForm); }}>
                  {t("generic.cancel")}
                </Button>
                ...
                records.map((r) => (
                  <TableRow key={r.id}>
                    <TableCell>
                      ...
                      >
                        {(r as any).patientName ?? `#${r.patientId}`}
                      </button>
                    </TableCell>
