...
const translations: Translations = {
  ...
  "billing.manageServices":       { en: "Manage Services",             ar: "إدارة الخدمات" },
  "billing.addNewService":        { en: "Add a new service",           ar: "إضافة خدمة جديدة" },
  "billing.serviceNamePlaceholder": { en: "Service name…",            ar: "اسم الخدمة…" },
  "billing.savedServices":        { en: "Saved services",              ar: "الخدمات المحفوظة" },
  "billing.resetToDefaults":      { en: "Reset to defaults",           ar: "إعادة التعيين" },
  "billing.confirmReset":         { en: "Click again to confirm",      ar: "انقر للتأكيد" },
  "billing.serviceAdded":         { en: "Service saved to catalog",    ar: "تم حفظ الخدمة في القائمة" },
  "billing.serviceDuplicate":     { en: "Service already exists",      ar: "هذه الخدمة موجودة بالفعل" },
  "billing.servicesReset":        { en: "Catalog reset to defaults",   ar: "تمت إعادة التعيين إلى الافتراضية" },
  "billing.noCatalogServices":    { en: "No services in catalog.",     ar: "لا توجد خدمات في القائمة." },
